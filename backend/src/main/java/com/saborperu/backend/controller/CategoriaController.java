...
public class CategoriaController {
    ...
    public ResponseEntity<Categoria> crear(@RequestBody @NonNull Categoria categoria) {
    ...
    public ResponseEntity<Categoria> actualizar(@PathVariable @NonNull Long id, @RequestBody Categoria categoria) {
        try {
